...
public class SerialNativeInterface {
    ...
    static {
        ...
        //since 2.3.0 ->
        if (osType == OS_WINDOWS) { // Save the native library not in the Home directory on Windows but in %APPDATA%
            libRootFolder = new File(winHome).canWrite() ? winHome : tmpFolder;
        } else {
        ...
        if (osType == OS_WINDOWS) { // Other directory name under Windows
